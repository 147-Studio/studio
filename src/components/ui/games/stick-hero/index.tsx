...
export default function StickHero() {
  ...
  useEffect(() => {
    ...
    function drawBackground() {
      ...
      gradient.addColorStop(0, "#216bf7");
      gradient.addColorStop(1, "#40b1fd");
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div ref={introRef} className={styles.introduction}>
          ماوس را نگه دارید تا چوب کشیده شود
        </div>

        <div ref={perfectRef} className={styles.perfect}>
          امتیاز دوبل
        </div>

        <button ref={restartRef} className={styles.restart}>
          شروع دوباره
        </button>
      </div>
    </footer>
